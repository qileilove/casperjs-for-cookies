...
casper.start('http://dev.gcbeta.com/login');
// casper.waitForSelector('input.btn.btn-primary.btn-block'); // wait for the form node to be added
casper.then(function() {
  this.fillSelectors('div.styles__loginFormContainer___2XJtM', {
      'input[type="text"]': 'qileilove',
      'input[type="password"]': 'qilei60636'
   });
  this.click('div  button  div  div'); // Click the login button instead of submitting the form
